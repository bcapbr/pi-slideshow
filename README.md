...
## ▶️ Start the slideshow

Once your folder is set:

1. Open the app
2. Load your image folder
3. Start playback
4. Check the screen
...
## 🔧 Using it on a shop or public screen
...
4. Open the app
5. Choose your slide folder
6. Start the slideshow
7. Put the screen in full screen mode
8. Leave the app open for display use
